-- 0025_add_tax_summary_dispatch.sql — analytics_dispatch에 tax_summary 추가.
--
-- monthly_tax_summary(GST/PST/LCT 계산)는 이미 있었는데(마이그레이션 0001에서 버그 수정)
-- Discord 봇의 Query Contract 목록엔 등록이 안 돼 있었다 — 오너가 GST/PST 신고하려고
-- 물어봤는데 봇이 "그런 데이터 없다"고 잘못 답함(실제 발견, 2026-09-08). 등록한다.
