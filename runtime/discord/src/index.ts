...
- social_sales_correlation: 인스타 포스트 발행일 + 이후 7일간(한 주), 그날그날 매출을 "그 요일 최근 4주 평균"과 비교(day_offset 0~7). 요일 편중을 피하려고 포스팅 당일이 아니라 각 offset일 자체의 요일 기준으로 비교한다 (인과관계 아님, 상관관계만). 평일에 올린 포스팅이 주말 매출에 영향을 줄 수 있다는 오너 관찰(2026-09-09)로 3일에서 7일로 확장함 — 며칠 지난 효과도 놓치지 마라. "포스팅하면 매출 늘어?", "포스팅하고 며칠 뒤에 효과 나타나?", "화요일에 올린 게 주말에 영향 있었어?" 류 질문에 사용
- post_item_trend: 특정 메뉴를 다룬 포스트 발행 후 0~7일간 그 메뉴 매출 추이 (item_name 필수, 영어 메뉴명. "라떼 포스트 올리고 라떼 잘 팔렸어?" 류 질문)
...
- 포스팅 이후 매출 추이(예: "포스팅하면 매출 늘어?", "효과가 며칠 가?")를 물으면 발행 당일(day_offset 0)
  만 보여주지 말고 0~7일차(한 주)를 전부 보여줘라 — 뒷심(잔존 효과)이 더 중요한 질문이고, 평일 포스팅이
  주말에야 효과가 나타나는 경우도 있다(오너 관찰, 2026-09-09)
